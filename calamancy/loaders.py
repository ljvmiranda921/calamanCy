...
def _get_models_url() -> Dict[str, str]:
    ...
    """
    return {
        "tl_calamancy_md-0.2.0": f"tl_calamancy_md @ https://huggingface.co/ljvmiranda921/tl_calamancy_md/resolve/{GIT_REF}/tl_calamancy_md-any-py3-none-any.whl",
        "tl_calamancy_lg-0.2.0": f"tl_calamancy_lg @ https://huggingface.co/ljvmiranda921/tl_calamancy_lg/resolve/{GIT_REF}/tl_calamancy_lg-any-py3-none-any.whl",
        "tl_calamancy_trf-0.2.0": f"tl_calamancy_trf @ https://huggingface.co/ljvmiranda921/tl_calamancy_trf/resolve/{GIT_REF}/tl_calamancy_trf-any-py3-none-any.whl",
        "tl_calamancy_md-0.1.0": f"tl_calamancy_md @ https://huggingface.co/ljvmiranda921/tl_calamancy_md-0.1.0/resolve/{GIT_REF}/tl_calamancy_md-0.1.0-py3-none-any.whl",
        "tl_calamancy_lg-0.1.0": f"tl_calamancy_lg @ https://huggingface.co/ljvmiranda921/tl_calamancy_lg-0.1.0/resolve/{GIT_REF}/tl_calamancy_lg-0.1.0-py3-none-any.whl",
        "tl_calamancy_trf-0.1.0": f"tl_calamancy_trf @ https://huggingface.co/ljvmiranda921/tl_calamancy_trf-0.1.0/resolve/{GIT_REF}/tl_calamancy_trf-0.1.0-py3-none-any.whl",
    }
