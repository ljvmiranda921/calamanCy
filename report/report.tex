...
Using spaCy as a foundation is optimal, given its popularity and tight integration with other frameworks like HuggingFace's transformers \citep{Wolf2019HuggingFacesTS}.
...
However, the combined treebank is still small ($\ll$ 20k tokens) for POS tagging and dependency parsing, so we followed the Universal Dependencies data split guidelines and performed 10-fold cross-validation \citep{Nivre2020UniversalDV}.
