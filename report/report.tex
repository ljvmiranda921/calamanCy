...
For languages, these include DaCy for Danish \citep{Enevoldsen2021DaCyAU} and HuSpaCy for Hungarian \citep{Orosz2022HuSpaCyAI}.
...
We aim to fill this development gap through calamanCy.
...
In addition, Tagalog has two Universal Dependencies treebanks, Tagalog Reference Grammar (TRG) \citep{Samson2018TRG} and Ugnayan \citep{Aquino2020ParsingIT}, with POS tags and relational structures.
