...
Universal Dependencies (UD) treebanks for Tagalog framework are tiny ($\ll$ 20k words) \citep{Samson2018TRG,Aquino2020ParsingIT}, 
...
\begin{itemize}
  ...
  \item \texttt{tl\_calamancy\_trf}: Transformer-based Tagalog pipeline. No pretraining. Instead of a static word embedding table, it uses context-sensitive vectors from the roberta-tagalog-base transformer \citep{Cruz2021ImprovingLL} (775 MB).
\end{itemize}
