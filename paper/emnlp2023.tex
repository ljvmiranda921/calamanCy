...
% This following sections will discuss the process of model development, benchmark results on existing Tagalog corpora, and showcase sample applications of calamanCy.
