...
\begin{itemize}
  ...
  \item \texttt{tl\_calamancy\_trf}: Transformer-based Tagalog pipeline. No pretraining. Instead of a static vector table, it uses context-sensitive vectors from the roberta-tagalog-base transformer \citep{Cruz2021ImprovingLL}.
\end{itemize}
