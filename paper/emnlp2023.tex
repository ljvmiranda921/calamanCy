...
We evaluated the calamanCy pipelines on various Tagalog benchmarks as seen in Table \ref{table:benchark_datasets}.
...
So instead, we used a held-out test split from \texttt{calamanCy-gold} for NER and then merged the two UD treebanks. 
