...
calamanCy-gold (Held-out test split) & Named entity recognition \textit{(Person, Organization, Location)} & A held-out test split from the calamanCy gold corpora (based from \cite{Cruz2021ImprovingLL}'s TLUnified) containing news reports. \\ 
...
\end{tabular}
\caption{
    Datasets for calamanCy benchmarking. 
