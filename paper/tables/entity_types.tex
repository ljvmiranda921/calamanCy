...
\end{tabular}
\caption{
Entity types used for annotating calamanCy-gold (derived from the TLUnified corpus of \citealp{Cruz2021ImprovingLL}).
Annotation guidelines can be found on Github: \url{https://github.com/ljvmiranda921/calamanCy/tree/master/datasets/tl_calamancy_gold_corpus/guidelines}
}
